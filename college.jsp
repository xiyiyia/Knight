...
<html>
  <head>
	...
	<style type="text/css">
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				//鼠标悬浮离开
				$("#changePwd, #manageSign, #logout").hover(
					function() {
				...
				//鼠标按下
				$("#changePwd, #manageSign, #logout").mousedown(function() {
					$(this).css("background-color", "#DDDDDD");
				});
				
				//鼠标松开
				$("#changePwd, #manageSign, #logout").mouseup(function() {
					$(this).css("background-color", "#E9EDFB");
				});
			
				$("#changePwd").click(function(){
					$("#myiframe").attr("src", "college/college_change_pwd.jsp");
				});
				
				$("#manageSign").click(function(){
					$("#myiframe").attr("src", "college/college_manage_sign.jsp");
				});
	...
	<body>
		...
		<div class="right">
			<iframe id="myiframe" src="college/college_change_pwd.jsp" class="miframe" frameborder="0"></iframe>
		</div>
  </body>
</html>
